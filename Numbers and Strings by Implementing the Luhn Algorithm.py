# The Luhn Algorithm
# is widely used for error-checking in various applications,
# such as verifying credit card numbers.

# Luhn Algorithm
# In this project, Implementation of the Luhn Algorithm.
...
def main():
    ...
    if verify_card_number(translated_card_number):
        print(f'CARD NUMBER: {card_number} -> VALID!')
    else:
        print(f'CARD NUMBER: {card_number} -> INVALID!')
